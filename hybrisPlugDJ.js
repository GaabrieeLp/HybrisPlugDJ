...
var loadedSound;
if(!loadedSound){
    loadedSound = new  Audio(decodeURIComponent("https://dl.dropboxusercontent.com/s/1qwhgujn6d0rbq7/chatsound.mp3"));   //(decodeURIComponent("https://gmflowplayer.googlecode.com/files/notify.ogg"));
}
